...
import { Wand2, Download, Palette, Sparkles } from 'lucide-react';
import { motion } from 'framer-motion';
import { CARD_THEMES, CardTheme, TarotCard } from '@/types/dream';
...
export const TarotCardGenerator: React.FC<TarotCardGeneratorProps> = ({ 
  dreamAnalysis, 
  onCardGenerated 
}) => {
  ...
  const generateCardImage = async () => {
    ...
    try {
      // Simulate image generation - in real app, this would call an AI image generation service
